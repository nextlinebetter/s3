# my version of `train_s3.sh`
data_name=demo/nq_hotpotqa_train

# Set default random seed
# RANDOM_SEED=${1:-3948}
RANDOM_SEED=${1:-42}

export CUDA_VISIBLE_DEVICES=0  # 2 of the 3 cards, different from retriever/generator
...
export GENERATOR_MODEL='claude'  # use claude API instead, [WARNING] This env var seems not effective
