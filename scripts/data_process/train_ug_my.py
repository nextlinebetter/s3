...
if __name__ == '__main__':
    ...
    for data_source in data_sources:
        ...
        # load local dataset
        dataset = datasets.load_dataset(f"{args.local_dir}/{data_source}", cache_dir="~/autodl-tmp/s3/cache/huggingface/datasets")
        ...
        train_dataset = train_dataset.map(function=make_map_fn('train'), with_indices=True, keep_in_memory=True)
